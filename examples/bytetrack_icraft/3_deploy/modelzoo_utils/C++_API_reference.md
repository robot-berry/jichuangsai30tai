...
`Session initSession(const std::string& run_backend,  const icraft::xrt::NetworkView& network, icraft::xrt::Device& device, int ocm_option = -1, bool mmuMode = true,bool open_speedmode = true, bool open_compressFtmp = true)`
