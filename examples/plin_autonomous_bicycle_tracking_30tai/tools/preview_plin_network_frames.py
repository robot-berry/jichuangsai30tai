...
<head>
  ...
  <style>
    body { margin: 0; background: #111418; color: #e8eef6; font-family: Segoe UI, Arial, sans-serif; }
    header { padding: 10px 14px; background: #1b222b; font-size: 14px; }
    img { display: block; width: 100vw; height: calc(100vh - 42px); object-fit: contain; background: #050607; }
  </style>
</head>
<body>
...
def publish_frame(image: Image.Image, out_dir: Path, frame_count: int, quality: int) -> Path:
