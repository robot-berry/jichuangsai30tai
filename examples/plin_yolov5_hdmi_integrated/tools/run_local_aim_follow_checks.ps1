...
Run-Step "Deploy script dry run" {
    powershell -NoProfile -ExecutionPolicy Bypass -File (Join-Path $ProjectDir "tools\deploy_30tai.ps1") -DryRun -Build -SmokeTest -FetchLogs
    if ($LASTEXITCODE -ne 0) {
